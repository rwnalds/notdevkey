<!--
  ...
  NOTE: image widgets render on GitHub (image proxy) but often NOT in a local
  markdown preview (VS Code / Obsidian). Push to the repo to see the real thing.
  Stats + top-language cards were left out because the public github-readme-stats
  instance is currently rate-limited (503); self-host to add them back reliably.
-->

<h1 align="center">Ronalds Palacis</h1>

<p align="center">
  <img src="https://readme-typing-svg.demolab.com/?font=Inter&weight=600&size=26&duration=3000&pause=800&color=C0CAF5&center=true&vCenter=true&width=560&height=45&lines=Founder+%26+full-stack+developer;I+build+the+product+and+sell+it;Klyiro+%C2%B7+E-commerce+growth+system" alt="tagline" />
</p>
...
The rest of the time I build products around that thesis: retention tooling and AI sales agents, plus the occasional hardware or music-tech experiments. I like the hard, unfashionable parts. Real-time rendering, systems programming, and the seam where design meets engineering.
...
- **Madara:** AI sales operator that finds dormant leads in Pipedrive, sends personalized reactivations, handles the replies, and briefs the sales team over WhatsApp. <!-- add repo link -->
